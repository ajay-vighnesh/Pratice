...
export class TrainingComponent {
 ...
 showPassword : boolean = true;
  ...
  validation() {
    ...
    } else if (this.userName === "ajay" && this.password === "ajay01") {
      alert('login success');
  ...
  onCopy(event: Event) {
    ...
    // Optionally, you can provide a message or perform other actions to notify the user
  ...
  items = [
    { name: 'Item A', available: true },
    { name: 'Item B', available: false },
    { name: 'Item C', available: true },
  ...
  today: Date = new Date();
  birthday : Date = new Date(6,20,2000);
  amount:number = 5000;
  message:string = "ajay";
  // value:string="vighnesh";

  // Pop-Up //

  message1: string = '@Input-Example : this message1 from parent2';
